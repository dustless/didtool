...
def plot_ks_in_cum(y_pred=None, y_true=None, out_path=None, file_name='pr_ks.png'):
    """
...
def plot_ks_in_tpr_fpr(y_pred=None, y_true=None, out_path=None, file_name='pr_ks.png'):
    """
